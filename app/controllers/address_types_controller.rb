class AddressTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @address_type.save
        format.html { redirect_to address_type_url(@address_type), notice: "Address type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @address_type.update(address_type_params)
        format.html { redirect_to address_type_url(@address_type), notice: "Address type was successfully updated." }
  ...
  private
    ...
    def address_type_params
      params.require(:address_type).permit(:address_type)
    end
end
