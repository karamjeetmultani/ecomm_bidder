class BidsController < ApplicationController
  before_action :set_bid, only: %i[ show edit update destroy, delete_bid ]#, except: [:delete_bid]
  # skip_before_action :set_bid, only: [:delete_bid]
  ...
  def bid_params
    params.require(:bid).permit(:product_id, :user_id, :bid_price)
  end
end
